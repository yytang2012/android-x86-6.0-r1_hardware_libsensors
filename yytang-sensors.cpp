...
static const struct sensor_t sSensorList[] = {
    ...
    { // 0
        ...
        maxRange: SENSOR_MAX_ACCELEROMETER,
        resolution: SENSOR_RES_ACCELEROMETER,
        power: 0.25f,
        minDelay: 0,
    ...
    { // 1
        ...
        maxRange: SENSOR_MAX_MAGNETIC_FIELD,
        resolution: SENSOR_RES_MAGNETIC_FIELD,
        power: 0.25f,
        minDelay: 0,
        fifoReservedEventCount: 0,
        fifoMaxEventCount: 0,
    ...
    { // 2
        ...
        maxRange: SENSOR_MAX_ORIENTATION,
        resolution: SENSOR_RES_ORIENTATION,
        power: 0.25f,
        minDelay: 0,
        fifoReservedEventCount: 0,
        fifoMaxEventCount: 0,
    ...
    { // 3
        ...
        maxRange: SENSOR_MAX_GYROSCOPE,
        resolution: SENSOR_RES_GYROSCOPE,
        power: 0.25f,
        minDelay: 0,
        fifoReservedEventCount: 0,
        fifoMaxEventCount: 0,
